...
public class fiveSpecimenFast extends OpMode {
    ...
    public void pathBuilder(){
        ...
        hang1 = follower.pathBuilder()
                .addPath(new BezierLine(new Point(eatPose.getX()-3.5, eatPose.getY()), new Point(specimen1.getX()-.25, specimen1.getY()-4))) //was 0
        ...
        hang3 = follower.pathBuilder()
                .addPath(new BezierLine(new Point(eatPose3), new Point(specimen3.getX(), specimen3.getY()+2.5))) //y was 1.5, x was 1.75
